...
const LoginPage = () => {
    ...
    return (
        <div className="grid grid-cols gap-2 max-w-[500px] w-full  rounded-sm p-10 items-center justify-center bg-white text-black ">
            <div className="login-tabs flex justify-center items-center gap-5 w-full ">
                <button
